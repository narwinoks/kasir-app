    ...
    <div class="container">
        <div class="col-md-12 mt-4 px-3">
            <h6 class="page-title h5">
                <small class="text-info h7">Ubah Menu</small>
            </h6>
            <div class="card bg-transparent border-info ">
                ...
                <div class="card-body">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" autocomplete="off" value="<?= $menu['menu_name']; ?>" name="nama_menu" class="form-control" />
                        <?= form_error('nama_menu', ' <small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-outline mb-4">
                        <label class="form-label" for="harga_menu">Harga Menu:</label>
                        <input type="text" autocomplete="off" value="<?= $menu['menu_price']; ?>" name="harga_menu" class="form-control" />
